...
pub use history::{
    HistoryCursor, HistoryWindow, QueryClause, ReviewHistoryEntry, ReviewHistoryFilters,
    ReviewHistoryOptions, ReviewHistoryResult, SearchRecord, build_haystack, matches_query,
